With NativeScript version 4.0.0, we can also show custom ActionBar in the modal page. To do that, we should declare a root frame and to set up our default modal page.
